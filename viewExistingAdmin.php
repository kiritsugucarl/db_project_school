...
# Unserialize the serialized url
...
<head>
    ...
    <title>OA Portal | View Data (Admin)</title>
...
<?php
# MySql Query to be done to Fetch the data using stud_id
$sql = "SELECT * FROM " . $tableName . " WHERE stud_id = '" . $id['stud_id'] . "';";
$query = mysqli_query($conn, $sql);

# Return all the values into an array
